...
__decorate([
    ...
    __metadata("design:type", Number)
], ConfigurationHistory.prototype, "userId", void 0);
__decorate([
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.STRING, allowNull: false }),
    __metadata("design:type", String)
], ConfigurationHistory.prototype, "name", void 0);
__decorate([
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.STRING, allowNull: true }),
    __metadata("design:type", String)
], ConfigurationHistory.prototype, "valueBefore", void 0);
__decorate([
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.STRING, allowNull: true }),
    __metadata("design:type", String)
], ConfigurationHistory.prototype, "valueAfter", void 0);
__decorate([
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.BOOLEAN, allowNull: false, defaultValue: false }),
    __metadata("design:type", Boolean)
], ConfigurationHistory.prototype, "isDeleted", void 0);
__decorate([
    sequelize_typescript_1.CreatedAt,
    __metadata("design:type", Date)
], ConfigurationHistory.prototype, "createdAt", void 0);
ConfigurationHistory = __decorate([
    (0, sequelize_typescript_1.Table)({ tableName: "configuration_history" })
], ConfigurationHistory);
exports.default = ConfigurationHistory;
