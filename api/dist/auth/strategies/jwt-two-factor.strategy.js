...
let JwtTwoFactorStrategy = class JwtTwoFactorStrategy extends (0, passport_1.PassportStrategy)(passport_jwt_1.Strategy, "jwt-two-factor") {
    constructor(config, userInfoCachingService, jwtCachingService) {
        super({
        ...
        this.jwtCachingService = jwtCachingService;
    }
...
exports.JwtTwoFactorStrategy = JwtTwoFactorStrategy = __decorate([
